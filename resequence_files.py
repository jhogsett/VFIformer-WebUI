...
def main():
    ...
    parser.add_argument("--file_type", default="png", type=str, help="File type of the files to resequence")
    ...
    parser.add_argument("--zero_fill", default=-1, type=int, help="Zero-filled width of new frame IDs, -1 = auto")
...
class ResequenceFiles:
    ...
    def resequence(self) -> None:
        ...
        for file in tqdm(files, desc=pbar_title):
            new_filename = self.new_base_filename + str(index).zfill(num_width) + "." + self.file_type
            old_filepath = file
