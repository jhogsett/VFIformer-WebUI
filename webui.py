...
def main():
    ...
    webui_events = WebuiEvents(engine, config, log, video_blender_state, video_blender_projects)
    ...
    while True:
        ...
        app = setup_ui(config, video_blender_projects, webui_events)
...
def setup_ui(config, video_blender_projects, webui_events):
