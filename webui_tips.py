...
class WebuiTips:
    ...
    video_blender_project_settings = gr.Markdown(load_markdown(tips_path, "video_blender_project_settings"))
    video_blender_frame_chooser = gr.Markdown(load_markdown(tips_path, "video_blender_frame_chooser"))
    video_blender_frame_fixer = gr.Markdown(load_markdown(tips_path, "video_blender_frame_fixer"))
    video_blender_video_preview = gr.Markdown(load_markdown(tips_path, "video_blender_video_preview"))
